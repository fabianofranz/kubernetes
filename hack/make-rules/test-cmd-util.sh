...
__EOF__
  ...
  kube::test::if_has_string "${output_message}" 'KUBECTL_PLUGINS_REST_CLIENT_CONFIG_HOST'
  kube::test::if_has_string "${output_message}" 'KUBECTL_PLUGINS_REST_CLIENT_CONFIG_TIMEOUT_MS=0'
